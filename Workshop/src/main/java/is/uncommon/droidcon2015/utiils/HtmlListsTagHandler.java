 ...
 * src/c866e64acc3336890cfde00fae2e59565fe0c1bf/app/src/main/java/fi/iki/kuitsi/listtest/MyTagHandler.java?at=master
 ...
 */
public class HtmlListsTagHandler implements Html.TagHandler {
    ...
    public HtmlListsTagHandler(int bulletRadius, int bulletColor) {
        this.mBulletRadius = bulletRadius;
        this.mBulletColor = bulletColor;
        this.indent = 4 * bulletRadius;
        this.listItemIndent = 2 * indent;
        this.bullet = new BulletSpan(indent);
    }
        ...
        if (tag.equalsIgnoreCase("ul")) {
            ...
            if (opening) {
                ...
                if (lists.peek().equalsIgnoreCase("ul")) {
                    ...
                    BulletSpan newBullet = new BulletSpan(bulletMargin, mBulletColor, mBulletRadius);
                    end(output,
                            Ul.class,
